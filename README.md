...
8. [ExpenseTrackerCLI]([https://github.com/yanamak89/TaskTracker](https://github.com/yanamak89/ExpenseTrackerCLI)) — a simple Command-Line Interface (CLI) Expense Tracker built with C#. This tool allows users to manage personal finances efficiently from the terminal.
